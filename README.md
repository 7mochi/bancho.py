...
git clone https://github.com/osuperu/bancho.py.git
...
# Use docker-compose up -d --force-recreate --build bancho
# if you have made changes to the project and want them to be reflected in the container
